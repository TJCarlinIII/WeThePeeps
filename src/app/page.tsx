...
import PublicIncidentTicker from '@/components/PublicIncidentTicker';
...
export default async function HomePage() {
  ...
  try {
    ...
    console.error("D1_RANDOMIZER_ERROR:", e); 
  }

  return (
    <main className="min-h-screen bg-black text-slate-300 font-mono flex flex-col relative overflow-x-hidden">
      {/* THE SIREN: Critical Incident Alerts - Fixed at top */}
      <PublicIncidentTicker />
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center p-6 py-20">
        <div className="max-w-4xl w-full text-center flex flex-col items-center">
          ...
          <div className="mb-16">
            ...
            <div className="h-px w-full bg-slate-900 mb-4" />
          </div>
