// File: src/app/admin/taxonomy/TaxonomyRegistry.tsx
"use client";
...
export default function TaxonomyRegistry({ initialTerms }: RegistryProps) {
  ...
  // REMOVED: <div className="flex..."> and <AdminSidebar />
  return (
    <div className="p-6 text-slate-300 font-mono">
      {/* HEADER SECTION */}
          ...
          <div className="flex justify-between items-center border-b border-slate-900 pb-4">
            ...
            <div className="flex gap-2">
              {['all', 'category', 'tag'].map((f) => (
                <button
                  key={f}
                  onClick={() => setActiveFilter(f as 'all' | 'category' | 'tag')}
